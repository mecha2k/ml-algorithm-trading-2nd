...
# Download the source data (Format 1) from [Stanford Deep Learning](http://ufldl.stanford.edu/housenumbers/) and place
# the extracted `train` and `test` folders in the directory `images/svhn`.
...
fig.tight_layout()
fig.savefig("images/12_sample_img.png", dpi=300)
