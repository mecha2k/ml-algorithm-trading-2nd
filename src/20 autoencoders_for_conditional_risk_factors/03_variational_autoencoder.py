...
# Adapted from [Building Autoencoders in Keras](https://blog.keras.io/building-autoencoders-in-keras.html)
# by Francois Chollet who created Keras.
...
if __name__ == "__main__":
    ...
    encoder.summary()
    plot_model(encoder, to_file="images/03_vae_mlp_encoder.png", show_shapes=True)
