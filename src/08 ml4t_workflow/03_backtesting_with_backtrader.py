...
if __name__ == "__main__":
    ...
    idx = pd.IndexSlice
    data = pd.read_hdf("../data/backtest.h5", "data").sort_index()
    ...
    # figure.savefig("../images/ch08_backtrader.png", dpi=300, bboxinches="tight")
    ...
    sns.despine()
    fig.tight_layout()
    plt.savefig("../images/ch08_backtrader.png", dpi=300, bboxinches="tight")
    ...
    fig.savefig("../images/ch8_pyfolio.png", dpi=300)
